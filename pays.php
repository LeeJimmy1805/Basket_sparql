...
<html>
	...
	?>	
     ...
     <section id="main" align="center" class="wrapper">
			 ...
			 <h1 class="logo" >Choisir un pays</h1>
       <?php
...
print "<p>Pays : ".sparql_num_rows( $result )." results.</p>";
...
while( $row = sparql_fetch_array( $result ) )
{
	...
	{
		print "<td><a href='./paysJoueur.php?pays=$row[$field]'>$row[$field]</a></td>";
	}
	print "</tr>";
}
print "</table>";
